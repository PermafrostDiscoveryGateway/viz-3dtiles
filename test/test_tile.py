...
def test_tile_add_children_and_bv_update_replace():
    ...
    c1 = Tile(boundingVolume=region(-1,-1,0,0,0,5), geometricError=5, content=Content(uri="a.b3dm"))
    c2 = Tile(boundingVolume=region(0,0,1,1,0,8), geometricError=4, content=Content(uri="b.b3dm"))
